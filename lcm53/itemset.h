...
//  int a;
  ...
  int lamp_stat; // case to change the statistical test in LAMP mode. 
  double lamp_alpha; // the significance level. 
...
#define YATE_CORR 0.5 // Yates correction factor for continuity used in Chi-square
